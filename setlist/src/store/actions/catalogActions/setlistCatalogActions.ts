...
export const openSetlistsCatalog = createAction(
    'OPEN_SETLIST_CATALOG'
)();
export const closeSetlistsCatalog = createAction(
    'CLOSE_SETLIST_CATALOG'
)();
...
export const readSetlistInCatalog = createAction(
    'READ_SETLIST'
)();
