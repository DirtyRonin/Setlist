...
import { IFilterBandActionProps, Catalog, INextLinkActionProps, IFilterBandActionResult, IBandEntityActionProps } from "models";
...
export const addBandToCatalog= createAsyncAction(
    ...
    "NEW_BAND_FAILURE",
    "NEW_BAND_CANCEL",
)<IBandEntityActionProps,Catalog,Error,string>();
