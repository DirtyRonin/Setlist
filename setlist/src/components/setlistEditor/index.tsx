...
import { ICustomEvent, ISetlistSong, ModalTypes } from 'models';
...
const SetlistEditor = ({ query, handleClose }: IProps): JSX.Element => {
    ...
    return <div>
        <DataTable
            ...
            columns={setlistEditorNode({ events, setlistId: id, songs, asyncExecute })}
            data={songs}
            pagination
